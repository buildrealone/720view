...
AFRAME.registerComponent('model-viewer', {
    ...
    initBackground: function () {
      ...
      backgroundEl.setAttribute('material', {
        ...
        colorTop: '#f5f1bf', // '#afb0b3', // '#3f4e8a', // '#37383c',
        colorBottom: '#dbdbd7', // '#afb0b3', // '#5778ff', // '#757575',
        side: 'back'
      });
    ...
    initEntities: function () {
      ...
      const modelPivotEl = this.modelPivotEl = document.createElement('a-entity');
      ...
      arShadowEl.setAttribute('shadow', 'true');
      arShadowEl.setAttribute('ar-shadow', 'opacity: 0.2');
    ...
    onThumbstickMoved: function (evt) {
      ...
      const modelScale = this.modelScale || modelPivotEl.object3D.scale.x;
